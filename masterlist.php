          ...
          <div class="box">
            <div class="box-header with-border">
             ...
             <!--  <p class="pull-left"><?php// echo "sy".$_SESSION['sy_id'].""; ?></p>
              ...
              <a class="btn  btn-xs pull-right" id="print-btn"><i style="color: green;" class="fa fa-print"></i> Print Report</a>
              <a class="btn btn-xs pull-right" id="print-btn"><i style="color: orange;" class="fa fa-refresh"></i> Refresh</a>
            </div>
            <div class="box-body" id="printhis" style="overflow-y: scroll;">
              <table id="masterlistable" class="table table-striped table-bordered">
                <thead>
                  <th>No.</th>
                  <th>IDnumber</th>
                  <th>Fullname</th>
