...
if(isset($_POST['rfid']) && isset($_POST['firstname']) && isset($_POST['lastname']) && isset($_POST['username']) && isset($_POST['password']) )
{
    ...
    $data = array($rfid,$position,$firstname,$middlename,$lastname,$username,$password,$image,$id_number);
...
if(isset($_SESSION['admin_id']) && isset($_POST['rfid']) && isset($_POST['username']) && isset($_POST['id_number']))
{
...
//  $password = sha1(md5($password));
 ...
 $image = $_SESSION['imagepath'];
  ...
  $data = array($adminid,$id_number,$rfid,$firstname,$middlename,$lastname,$username,$image);
  //var_dump($data);
...
if(isset($_POST['cpass'])){
    ...
    //echo($password);
    $result = $admin->change_password($password);
    echo $result;
