             ...
             <table class="table" id="table">
                  ...
                  <div class="row">
                   ...
                   <div class="s_info">
                    <div>
                     ...
                     <h5>Name: &nbsp<b><span class="fn"></span> <span class="mn"> </span> <span class="ln"></span> </b></h5>
                     <h5>Year/Section: &nbsp<b><span class="year"></span> <span class="section"> </span> </b></h5>
                     <h5>Course/Major: &nbsp<b><span class="course"></span> - <span class="major"></span> </b></h5>
                     </div>
                   </div>
                   <div >
                    <br>
                <div class="s_info" >
                  <div >
                   ...
                   <hr>
                   <input type="button"  class="btn btn-success btn-xs" id="print" value="Submit Payment">
