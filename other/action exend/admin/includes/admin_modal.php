...
<div class="modal fade" id="change-pass">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" id="admin_changepass_form" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="password" class="form-control" id="currentpassword" name="currentpassword" placeholder="input current password to save changes" required>
                    </div>
                </div>
            ...
            <div class="modal-footer">
              <!-- <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button> -->
              <button type="button" class="btn btn-success btn-flat change_password" ><i class="fa fa-check-square-o"></i> Save Changes</button>
              </form>
            </div>
        </div>
    </div>
