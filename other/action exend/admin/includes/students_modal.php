...
<div class="modal fade" id="print_option_model">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <p class="pull-left">Modify Data</p>  -->
          
           
            
            
              <!-- <button type="button" class="btn btn-success btn-sm cprint102" ><i class="fa fa-print"></i> Modify Data</button> -->
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control input-sm" id="taprfid" name="taprfid">
                    </div>
                    <?php 
                      $eid = $_GET['id'];
                     echo '<input type="hidden" class="eventid" name="eventid" value='.$eid.' >';
                     ?>
                </div> 
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
              <button type="button" class="btn btn-success btn-flat attend" name="attend">okay</button>
              </form>
            </div>
        </div>
    </div>
