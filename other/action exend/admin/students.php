        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a id="btn" href="#import_excel" data-toggle="modal" class="btn btn-default btn-sm btn-flat pull-right"><i class="fa fa-download"></i> Import Data(csv excel file)</a>
              <a id="btn"  class="btn btn-default btn-sm btn-flat pull-right btn_print"><i class="fa fa-print"></i> Print</a>
              <a id="btn" class="btn btn-default btn-sm btn-flat pull-right xexport"><i class="fa fa-upload"></i> Export (Excel)</a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" id="upload_csv_form" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-10">
                <h6 class="text-danger">Note: <span style="font-style:italic;">Can't add student if the RFID and IDNUMBER is Duplicate.</span></h6>
                <h6 class="text-danger">Note: <span style="font-style:italic;">See below table on what the exactly correct alignment og column name.</span></h6>
                </div>
            </div>
