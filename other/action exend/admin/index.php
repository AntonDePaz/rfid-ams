    	...
    	<form  method="POST" id="form_admin">
          ...
          <div class="errorm"><p class="errormsg" style="color: red;"></p></div>
            ...
            <div class="col-xs-3"></div>
    			<div class="col-xs-6">
          			<button type="submit" class="btn btn-primary btn-block btn-flat" id="login" name="login"><span class="load"><i class="fa fa-sign-in"></i> Sign In</span></button>
        		</div>
      		</div>
    	</form>
  	</div>
...
<footer>
<p><center>Have a account? Login Details Are Provided by President Officer<center></p></footer>
</html>
