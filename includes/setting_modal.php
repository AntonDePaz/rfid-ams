        ...
        <div class = "modal-dialog" role = "document">
          <div class = "modal-content ">
            <div class = "modal-body">
              ...
              <center><label>Are you sure you want to Clear all Data for <span class="text-info syconfirm_cleardatamodal_range_data" style="font-style: italic;"></span> ?</label></center>
              <br />
              <h6 style="margin-left: 50px; font-style: italic; color: red;"> <i class="fa fa-info-circle"></i> Note:  After Deleting Data will not be recover again.</h6>
              <br />
              ...
              <form class="form-horizontal" method="POST">
               <input type="hidden" class="SY_id">
                <div class="form-group" id="cleardatamodal_hide">
                 ...
                 <center><div class="sy_loading"></div></center>
              <br />
             <center> <h6 style="margin-left: 50px; font-style: italic; color: red;"><i class="fa fa-info-circle"></i> Note: After Deleting Data will not be recover again.</h6></center>
              <br />
