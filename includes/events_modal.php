        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                          ...
                          <div class="col-md-6">
                             ...
                             <input type="time" name="edit_time" id="edit_time"  class="form-control" required pattern=".*\S.*"> 
          ...
          <div class = "modal-content ">
            <div class = "modal-body">
              ...
              <center><h5 >Are you sure you want to delete <b style="font-style: italic;"  class="eventdescription"></b>?</h5>
                <br>
                <h6 class="text-danger"> <i class="fa fa-info-circle"></i> Note: Be careful for deleting events it also remove the fines for every students in masterlist.</h6></center>
              <center>
                <span id="cyes">
