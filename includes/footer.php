<footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b style="font-size:11px;"> RFID Based Attendance Management System</b>
      <p style="font-size: 10px; margin-top: -2px; ">&copy; <script>  document.write(new Date().getFullYear()); </script> Develop by <a  href="https://www.facebook.com/jayr.depaz.5" target="_blank"> Antonio De Paz Jr </a></p>
    </div>
